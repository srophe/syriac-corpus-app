...
module namespace srophe-util-date="http://srophe.org/ns/srophe-util-date";
...
(:~
 ...
 :)    
 (:
declare function srophe-util-date:add-custom-dates(){
   if(ends-with($srophe-util-date:resource-uri),'.xml') then srophe-util-date:custom-dates-doc($srophe-util-date:resource-uri)
   else srophe-util-date:custom-dates-coll($srophe-util-date:resource-uri)
                            
};
:)
declare function srophe-util-date:custom-dates-coll($resource-uri){
...
return 
    (
            ...
            if(srophe-util-date:notAfter($doc) = 'success') then
                srophe-util-date:add-change-log($doc,$comment, $editor)
            else if(srophe-util-date:notBefore($doc) = 'success') then 
                srophe-util-date:add-change-log($doc,$comment, $editor)
            else if(srophe-util-date:to($doc) = 'success') then 
                srophe-util-date:add-change-log($doc,$comment, $editor)
            else if(srophe-util-date:from($doc) = 'success') then 
                srophe-util-date:add-change-log($doc,$comment, $editor)
            else if(srophe-util-date:when($doc) = 'success') then 
                srophe-util-date:add-change-log($doc,$comment, $editor)
            else () 
    ) 
};

declare function srophe-util-date:custom-dates-doc($resource-uri){
