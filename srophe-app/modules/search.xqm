...
let $syr-title := 
             if($hit/descendant::*[@syriaca-tags='#syriaca-headword'][1]) then
                if($hit/descendant::*[@syriaca-tags='#syriaca-headword'][matches(@xml:lang,'^syr')][1]/child::*) then 
                 string-join($hit/descendant::*[@syriaca-tags='#syriaca-headword'][matches(@xml:lang,'^syr')][1]/child::*/text(),' ')
                else string-join($hit/descendant::*[@syriaca-tags='#syriaca-headword'][matches(@xml:lang,'^syr')][1]/text(),' ')
             else 'NA' 
return
